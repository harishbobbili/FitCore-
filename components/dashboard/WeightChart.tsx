...
export const WeightChart: React.FC = () => {
  ...
  if (data.length === 0) {
    return (
      <div className="w-full h-[220px] bg-white/[0.01] rounded-xl flex items-center justify-center">
        <span className="text-xs text-white/20">No weight data available</span>
      </div>
    );
  }
