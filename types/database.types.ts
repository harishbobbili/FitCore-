    ...
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          age: number | null;
          fitness_goal_detail: string | null;
          created_at: string;
        };
        Insert: {
          id: string;
...
export type ProgressPhotosRow = Database["public"]["Tables"]["progress_photos"]["Row"];
export type ProgressPhotosInsert = Database["public"]["Tables"]["progress_photos"]["Insert"];
export type ProgressPhotosUpdate = Database["public"]["Tables"]["progress_photos"]["Update"];
