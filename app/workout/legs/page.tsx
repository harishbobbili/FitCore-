...
export default function LegsPage() {
  ...
  const exercises = EXERCISE_LIST.legs;
  const splitName = "Leg Day Split";
  ...
  return (
    <div className="flex flex-col gap-6 pb-12">
      <PageHeader
        title="Legs"
        subtitle="Lower body session targeting quads, hamstrings, glutes, and calves for leg development."
      ...
      <GlassCard className="py-4 px-6 flex items-center justify-between border-neonPurple/20 bg-brandCard/40">
        <div>
          ...
          <p className="text-xs text-white/40 mt-0.5">Start your Leg Day session</p>
        </div>
        <NeonButton
          variant="gradient"
          glow
