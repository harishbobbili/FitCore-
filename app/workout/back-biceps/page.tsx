...
export default function BackBicepsPage() {
  ...
  const exercises = EXERCISE_LIST["back-biceps"];
  const splitName = "Back + Biceps Split";
  ...
  return (
    <div className="flex flex-col gap-6 pb-12">
      <PageHeader
        title="Back + Biceps"
        subtitle="Pull-focused session targeting lats, mid-back, and biceps for width and thickness."
      ...
      <GlassCard className="py-4 px-6 flex items-center justify-between border-neonPurple/20 bg-brandCard/40">
        <div>
          ...
          <p className="text-xs text-white/40 mt-0.5">Start your Back + Biceps session</p>
        </div>
        <NeonButton
          variant="gradient"
          glow
