...
export default function ChestTricepsPage() {
  ...
  const exercises = EXERCISE_LIST["chest-triceps"];
  const splitName = "Chest + Triceps Split";
  ...
  return (
    <div className="flex flex-col gap-6 pb-12">
      <PageHeader
        title="Chest + Triceps"
        subtitle="Push-focused session targeting chest, shoulders, and triceps for upper body development."
      ...
      <GlassCard className="py-4 px-6 flex items-center justify-between border-neonPurple/20 bg-brandCard/40">
        <div>
          ...
          <p className="text-xs text-white/40 mt-0.5">Start your Chest + Triceps session</p>
        </div>
        <NeonButton
          variant="gradient"
          glow
