...
import { Scale, TrendingUp, Flame, CheckCircle, RefreshCw } from "lucide-react";
    ...
    <ErrorBoundary>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <GlassCard className="p-5" hoverable>
          <h3 className="text-sm font-bold uppercase tracking-wider text-white mb-4">Log Measurement</h3>
